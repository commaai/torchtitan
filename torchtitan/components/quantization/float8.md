...
* `precompute_float8_dynamic_scale_for_fsdp`: set to `True` for FSDP/HSDP recipes that use TorchAO FP8 all-gather and should precompute dynamic weight scales after each optimizer step.
